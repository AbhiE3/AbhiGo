    ...
    <div className="bg-teal-900 min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight tracking-widest">
            FAST TICKETS
          </h1>
          <h2 className="text-5xl md:text-7xl font-extrabold text-emerald-600 tracking-widest">
            HAPPY TRIPS.
          </h2>
        </div>
        {/* Filter Panel */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-full max-w-4xl px-4">
          <div className="bg-white p-6 rounded-2xl shadow-2xl grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
            <div className="col-span-1">
              ...
              <select
                className="w-full p-3 bg-gray-100 border-transparent rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
                value={filterOrigin}
            ...
            <div className="col-span-1">
              ...
              <button className="w-full bg-emerald-700 hover:bg-emerald-800 text-white font-bold py-3 px-4 rounded-lg transition-colors">
                Search
              </button>
            </div>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            {filteredBuses.map((bus) => (
              <div
                key={bus.id}
                className="bg-gray-200 rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 flex flex-col md:flex-row items-center"
              >
                ...
                <div className="p-6 w-full md:w-auto">
                  <button
                    ...
                    className="w-full md:w-auto bg-emerald-700 hover:bg-emerald-800 text-white font-bold py-3 px-8 rounded-lg transition-colors duration-300"
                  >
                    Book Now
                  </button>
                </div>
